        ...
        <div className="row m-5">
          <div className="col-md-6">
            <button className="card text-center" onClick={()=>handleDashboard('add')}>
              <img src={require("/home/shux/EsdProjects/frontend/src/assets/add_employee.jpg")} className="card-img"/>
          ...
          <div className="col-md-6">
            <button className="card text-center" onClick={()=>handleDashboard('allEmp')}>
              <img src={require("/home/shux/EsdProjects/frontend/src/assets/get_employee.png")} className="card-img"/>
                <div className="card-body">
